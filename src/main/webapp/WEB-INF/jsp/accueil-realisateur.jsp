...
<%@ page import="com.aina.spring_mvc.model.FilmSery" %>
<% List<FilmSery> tournageList=(List<FilmSery>) request.getAttribute("films");%>
<!DOCTYPE html>
<html lang="en">
        ...
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="deconnnexionauteur">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                            <% for (int i=0;i<tournageList.size();i++){ %>
                            <tr>
                                <th scope="row"><%=tournageList.get(i).getId()%></th>
                                <td><a href="listescene?idtournage=<%=tournageList.get(i).getId()%>"><%=tournageList.get(i).getTitre()%></a></td>
                                <td><%=tournageList.get(i).getDuree()%> minutes</td>
                            </tr>
                            <% } %>
                            </tbody>
                        </table>
